...
import { getSistemas, getPlanos, getAdicionais } from "./lib/supabase/data-service.ts"
import { generateFinancePdf } from "./lib/pdfFinanceGenerator.ts"
import type { Sistema, Plano, Adicional } from "./types.ts"
